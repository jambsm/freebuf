...
public class deptih_fragment extends Fragment {
    ...
    public deptih_fragment() {
    }
    @SuppressLint("ValidFragment")
    public deptih_fragment(String path) {
        this.sBasePath=path;
    }

    @Override
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view=inflater.inflate(R.layout.deptih_tab,container,false);
        ...
        recycle.addOnScrollListener(new RecyclerView.OnScrollListener() {
            ...
            public void onScrollStateChanged(RecyclerView recyclerView, int newState) {
                ...
                if(lastVisibleItem+1==adapter.getItemCount()){
                    ...
                    //String base="http://www.freebuf.com/news/special/";
