...
public class point_fragment extends Fragment {
    ...
    String sBasePath;
    public point_fragment() {
    }

    @SuppressLint("ValidFragment")
    public point_fragment(String path) {
        this.sBasePath=path;
    }
    @Override
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view=inflater.inflate(R.layout.point_tab,container,false);
        recycle=(RecyclerView)view.findViewById(R.id.rec_point);
        ...
        recycle.addOnScrollListener(new RecyclerView.OnScrollListener() {
            ...
            public void onScrollStateChanged(RecyclerView recyclerView, int newState) {
                ...
                if(lastVisibleItem+1==adapter.getItemCount()){
                    ...
                    //String base="http:http://www.freebuf.com/articles/neopoints/";
